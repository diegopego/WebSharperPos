(function(Global)
{
 ...
 Client.Main$19$20=function(rvReversed)
 {
  return function(e)
  {
   ...
   {
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("WebSharperTest:WebSharperTest.Server.DoSomething:235072806",[e.Vars.Hole("texttoreverse").$1.Get()]),function(a)
    {
     rvReversed.Set(a);
